...
// CHANGE TO public class PaintJob{} when doing exercise online
public class paintJobExercise {
        ...
        public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
            ...
            double totalBucketsNeeded = Math.ceil(areaToCover / areaPerBucket);
            int bucketsToBuy = (int) (totalBucketsNeeded - extraBuckets);
