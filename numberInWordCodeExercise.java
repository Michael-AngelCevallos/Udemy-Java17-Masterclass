...
NOTE: Do not add main method to solution code. <-------------- FOR UDEMY COURSE (JUST DONT ADD MAIN METHOD, ONLY ADD CODE FROM METHOD)
 * 
 */
...
public class numberInWordCodeExercise {
