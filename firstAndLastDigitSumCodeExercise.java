/* First and Last Digit Sum Code Exercise -
 * 
...
public class firstAndLastDigitSumCodeExercise {

    public static int sumFirstAndLastDigit(int number) {
        if (number < 0) {
            return -1; // Invalid value for negative number
        }
        ...
        // Returning the sum of first and last digits
